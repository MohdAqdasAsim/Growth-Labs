...
from ...models.agents.agent_outputs import StrategyAgentOutput
...
class StrategyAgent:
    ...
    def generate_strategy(
        ...
        return self.gemini.generate_strategy(goal, creator_context, duration_days, goal_type, past_learnings)
