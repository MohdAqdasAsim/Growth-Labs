...
class CreatorProfile(BaseModel):
    ...
    # ===== PHASE 1: GLOBAL ONBOARDING (REQUIRED) - 4 fields =====
    ...
    existing_platforms: list[str] = Field(default_factory=list, description="Platforms you're already active on")
    target_platforms: list[str] = Field(default_factory=list, description="Platforms you want to grow on")
    ...
    competitor_accounts: dict = Field(default_factory=dict, description="Platform-specific competitor accounts: {youtube: [handles], twitter: [handles]}")
